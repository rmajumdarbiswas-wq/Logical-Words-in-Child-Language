...
# changed the data sets from "Eng-NA" and "Eng-UK" to "Spanish" to account for extracting the Spanish data set
#Getting data from 1270 children in 73 corpora...
all_english_tokens <- get_tokens(collection = c("Spanish"), 
